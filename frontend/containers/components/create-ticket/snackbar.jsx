                  ...
                  <Col className="container-center" xs={11} sm={10} md={10} lg={10}>
                    <Row>
                      <Col xs={12} sm={12} md={6} lg={6}>
                        <Input type="number" label="Min MMR" elementId="min_mmr" name="min_mmr"/>
                      </Col>
                      <Col xs={12} sm={12} md={6} lg={6}>
                        <Input type="number" label="Max MMR" elementId="max_mmr" name="max_mrr"/>
                      </Col>
                    </Row>
                    <Row>
                      <Col xs={12} sm={12} md={6} lg={6}>
                        <Input type="number" label="Price" elementId="price" name="price"/>
                      </Col>
                      <Col xs={12} sm={12} md={6} lg={6}>
                        <Input type="number" label="Day used" elementId="day_used" name="day_used"/>
                      </Col>
                    </Row>
                  </Col>
                </Row>
